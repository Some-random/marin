...
P2_SCRIPT=$MARIN/experiments/data_efficiency/run_1_4b_c5v8r_phase2.py
...
nohup $MARIN/experiments/data_efficiency/multi_node_launch.sh \
  ...
  --config experiments/data_efficiency/run_1_4b_c5v8r_phase2.py \
  --run-tag "$P2_TAG" \
...
nohup bash -c "
bash $MARIN/experiments/data_efficiency/convert_and_eval_v2.sh \
  --label $P1_LABEL \
  --src $P1_CKPT \
  --hf-dst $P1_HF \
...
ssh gpu-dy-p4d24xlarge-5 'bash $MARIN/experiments/data_efficiency/run_paloma_for_model.sh $P1_LABEL $P1_HF' \
  > $MARIN/logs/paloma_${P1_LABEL}_${V2_TS}.log 2>&1
ssh gpu-dy-p4d24xlarge-5 'bash $MARIN/experiments/data_efficiency/run_gsm_for_model.sh $P1_LABEL $P1_HF' \
  > $MARIN/logs/gsm_${P1_LABEL}_${V2_TS}.log 2>&1
ssh gpu-dy-p4d24xlarge-5 'bash $MARIN/experiments/data_efficiency/run_aryabumi_nl_extras.sh $P1_LABEL $P1_HF' \
  > $MARIN/logs/aryabumi_nl_extras_${P1_LABEL}_${V2_TS}.log 2>&1
ssh gpu-dy-p4d24xlarge-5 'bash $MARIN/experiments/data_efficiency/run_quac_for_model.sh $P1_LABEL $P1_HF' \
