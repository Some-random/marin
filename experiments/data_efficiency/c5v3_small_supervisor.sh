...
ssh -o ConnectTimeout=5 -o StrictHostKeyChecking=no $TRAIN_NODE "
  ...
  nohup .venv/bin/python -m experiments.data_efficiency.run_1_4b_c5v3_small_phase1 > $P1_LOG 2>&1 < /dev/null &
  disown
"
...
ssh -o ConnectTimeout=5 -o StrictHostKeyChecking=no $TRAIN_NODE "
  ...
  nohup .venv/bin/python -m experiments.data_efficiency.run_1_4b_c5v3_small_phase2 > $P2_LOG 2>&1 < /dev/null &
  disown
"
