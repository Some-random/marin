...
Each band is fetched via `experiments.data_efficiency.fetch_stack_edu_python_score_range`
...
Run via:
    ...
    MARIN_PREFIX=/fsx/users/dongweij/marin/outputs .venv/bin/python -m experiments.data_efficiency.code_data_lower_tiers
"""
