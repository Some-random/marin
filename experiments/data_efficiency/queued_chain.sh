...
bash /fsx/users/dongweij/marin/experiments/data_efficiency/run_wd3_2_x16_evals.sh
...
.venv/bin/python -m experiments.data_efficiency.run_1_4b_wd1_6_x8_nocrossblock
