...
"""
1.4B WD-vs-epoch ablation: WD=3.2, 16 epochs, block_cross_document_attention=False.

Hypothesis: holding epochs=16, does WD=3.2 produce a looping or non-looping model?
Combined with the wd=1.6/x16 result (no loop), this isolates whether the looping fix
is from epochs (x8 → x16) or WD (3.2 → 1.6).

Diffs from run_1_4b_wd1_6_x16_nocrossblock.py:
  - weight_decay: 1.6 -> 3.2
  - Checkpoint path: checkpoints/1_4b_wd3_2_x16_nocrossblock/
  - Tag changes (wd_3.2)

All else identical: 209M × 16 epochs, LR=1e-3 cosine→0, batch=64, seq=4096, seed=0,
data_seed=0, block_cross_document_attention=False.
"""
...
train_config = TrainLmConfig(
    ...
    trainer=TrainerConfig(
        ...
        tracker=WandbConfig(
            ...
            tags=["data-efficiency", "1.4b", "wd-epoch-ablation", "dclm_200m", "wd_3.2", "x16-epoch", "data_seed_0", "no-cross-doc-block"],
        ),
        ...
        checkpointer=CheckpointerConfig(
            base_path="checkpoints/1_4b_wd3_2_x16_nocrossblock/",
