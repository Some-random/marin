"""Convert C5-v2 final (step-29343) Levanter checkpoint to HF format."""
...
SRC = "/fsx/users/dongweij/marin/checkpoints/1_4b_1ep_c5v2_clean_code/u23atfbm/step-29343"
DST = "/fsx/users/dongweij/marin/checkpoints/c5v2_final_step29343_hf"
...
def main():
    ...
    print(f"=== c5v2_final: {SRC} -> {DST} ===", flush=True)
