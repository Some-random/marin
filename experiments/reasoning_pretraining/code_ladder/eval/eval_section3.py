...
LOG_DIR = REPO / "logs"
MD = REPO / "experiments" / "reasoning_pretraining" / "code_ladder" / "docs" / "EVALUATION.md"
EVAL_SCRIPT = REPO / "experiments" / "reasoning_pretraining" / "code_ladder" / "eval" / "convert_and_eval_v2.sh"
RUN_EVAL_V2 = REPO / "experiments" / "reasoning_pretraining" / "code_ladder" / "eval" / "run_eval_v2.sh"
RUN_PALOMA = REPO / "experiments" / "reasoning_pretraining" / "code_ladder" / "eval" / "run_paloma_for_model.sh"
RUN_GSM = REPO / "experiments" / "reasoning_pretraining" / "code_ladder" / "eval" / "run_gsm_for_model.sh"
