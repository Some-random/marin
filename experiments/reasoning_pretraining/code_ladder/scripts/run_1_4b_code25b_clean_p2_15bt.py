...
NUM_TRAIN_STEPS = 14_672  # 15.39 B text — MATCHES C5-v6's phase 2 exactly, removing the text-budget
                          # confound (the 5B run was run_1_4b_code25b_clean_p2.py). Only the phase-1
                          # code base now differs: code25b_clean (24.65B >=2.7) vs C5-v6 (15.4B >=3.0).
...
train_config = TrainLmConfig(
    ...
    trainer=TrainerConfig(
        ...
        tracker=WandbConfig(
            ...
            tags=["1.4b", "code25b_clean", "phase2-30pct-replay-DCLM", "code-as-prior", "15.4B-text", "matched-text-vs-c5v6", "wd-0.1", f"nodes-{NUM_PROC}"],
            save_code=False,
        ),
        ...
        checkpointer=CheckpointerConfig(
            base_path="checkpoints/1_4b_code25b_clean_p2_15bt/",
...
if __name__ == "__main__":
    print("=== 1.4B code25b_clean PHASE 2 (15.4B-text continuation, 30% replay + DCLM — MATCHED to C5-v6 phase 2) ===")
