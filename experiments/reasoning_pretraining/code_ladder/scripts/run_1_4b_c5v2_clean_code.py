...
# stage-2 mix.
#
# Data sources (all tokenized with Llama-3.1 via experiments.reasoning_pretraining.code_ladder.data.code_data_c5v2):
#   Code (80% in stage 1):
...
if not _code_components or not _markup_components:
    ...
    warnings.warn(
        ...
        "Run `python -m experiments.reasoning_pretraining.code_ladder.data.code_data_c5v2` first.",
        stacklevel=2,
    )
