"""Convert C5-v2 small (step-12799) to HF format."""
...
SRC = "/fsx/users/dongweij/marin/checkpoints/1_4b_c5v2_small/5hb7vl3u/step-12799"
DST = "/fsx/users/dongweij/marin/checkpoints/c5v2_small_step12799_hf"
...
def main():
    ...
    print(f"=== c5v2_small: {SRC} -> {DST} ===", flush=True)
