...
# 1.4B C5-v6 PHASE 2: continued text pretraining with HIGHER code+markup replay.
#
...
PHASE1_INIT_FROM = "checkpoints/1_4b_c5v3_phase1_half/mvbbqfpo/step-7335"
...
train_config = TrainLmConfig(
    ...
    trainer=TrainerConfig(
        ...
        tracker=WandbConfig(
            ...
            tags=["1.4b", "c5v3-half-p2", "code-budget-0.5x", "phase2-30pct-code-replay", "dclm", "wd-0.1", f"nodes-{NUM_PROC}"],
            save_code=False,
        ),
        ...
        checkpointer=CheckpointerConfig(
            base_path="checkpoints/1_4b_c5v3_half_p2/",
...
if __name__ == "__main__":
    print("=== 1.4B C5-v3-HALF PHASE 2 (0.5x code base → 15.4B text, 30% code+markup replay + DCLM) ===")
