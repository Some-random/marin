...
# experiments/reasoning_pretraining/code_ladder/docs/cluster_nodes.txt (lines starting with `#` skipped).
#
...
#
# Usage:
#   experiments/reasoning_pretraining/code_ladder/orchestration/launch_on_idle.sh \
...
NODES_FILE=/fsx/users/dongweij/marin/experiments/reasoning_pretraining/code_ladder/docs/cluster_nodes.txt
SCRIPT=""
LOG=""
NAME="job"
EXCLUDE=""
