...
./experiments/reasoning_pretraining/code_ladder/orchestration/multi_node_launch.sh \
  --nodes "$NODES_CSV" \
  --config experiments/reasoning_pretraining/code_ladder/scripts/run_1_4b_c5v2_clean_code.py \
  --run-tag "$RUN_TAG" \
